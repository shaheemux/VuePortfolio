...
<div class="gridy-1 gridyhe-1">
  ...
  <div class="gridinfo">
    ...
    <a href="https://drive.google.com/file/d/1PDAWNmQqCu14PNnpVd18Nt6pNAhXsGOs/view?usp=sharing" target="_blank" class="grid-btn grid-more"><span>More</span> <i class="fa fa-plus"></i></a>
  </div>
</div>
     </div>
    </div>
